...
export default function ServicosSite4(){
            ...
            <div className="serv-site__container">
                ...
                <div className="serv-site-3__container">
                    <p className="serv-site__label">
                        Muito obrigada , sua solicitação foi enviada para análise e em até 3 dias úteis você saberá o valor exato para desenvolvimento da plataforma e definirá a forma de pagamento.
                        <br/>
                        <br/>
